        ...
        // Set the map's camera position to the current location of the device.
          if(json!=null) {
              ...
              try {
                  ...
                  String tmpLat = json.getString("latitude");
                  System.out.println("LatitudeStr:" + tmpLat);
                  tmpLat = tmpLat.substring(0, tmpLat.length()-1);
                  latitude = Double.parseDouble(tmpLat);
                  System.out.println("LatitudeDb:" + latitude);


                  String tmpLng = json.getString("longitude");
                  System.out.println("longitudeStr:" + tmpLng);
                  tmpLng = tmpLng.substring(0, tmpLng.length()-1);
                  longitude = Double.parseDouble(tmpLng);
                  System.out.println("longitudeDb:" + longitude);
